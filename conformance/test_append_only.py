...
def test_active_assertion_is_returned_by_default(make_kb: KbFactory) -> None:
...
def test_retracted_assertion_excluded_from_default_query(make_kb: KbFactory) -> None:
...
def test_retracted_assertion_survives_in_history(make_kb: KbFactory) -> None:
...
def test_value_field_is_immutable(make_kb: KbFactory) -> None:
...
def test_multiple_assertions_coexist_for_same_predicate(make_kb: KbFactory) -> None:
...
def test_provenance_fields_are_captured(make_kb: KbFactory) -> None:
...
def test_assertion_records_survive_connection_close(make_kb: KbFactory) -> None:
    ...
    kb2 = make_kb(reuse_path=make_kb.last_path)
