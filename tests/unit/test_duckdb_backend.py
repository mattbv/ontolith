...
from ontolith.store.duckdb import DuckDBBackend, migrations
...
class TestDuckDBBackend:
    ...
    def test_get_entity_by_natural_key(self, backend: DuckDBBackend) -> None:
    ...
    def test_get_entity_by_natural_key_no_match_returns_none(self, backend: DuckDBBackend) -> None:
    ...
    def test_proposal_reviewers_migration_adds_new_column_to_existing_db(
        ...
        # already-current file reports nothing pending.
...
class TestCandidateIdsNarrowing:
    ...
    def _seed_flagged_with_window(self, backend: DuckDBBackend, entity_id: str) -> None:
    ...
    def test_entities_meeting_confidence_as_of_include_flagged(
        ...
        flagged the way it did before this KI."""
    ...
    def test_entities_meeting_trust_as_of_include_flagged(self, backend: DuckDBBackend) -> None:
