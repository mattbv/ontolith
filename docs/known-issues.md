...
**Deliberately out of scope:** REST/GraphQL/MCP/CLI parity — `supersedes` is SDK-only for now, matching this project's established pattern of shipping a capability SDK-first and filing interface parity separately (e.g. KI-081 → KI-094/KI-096). **Filed as its own follow-up: KI-099** (below).
