...
- ADR-0036: RDF/OWL Bridge (`XSD.double` for the same `Float` value_type — the mapping this
  Update reconciles with; ADR-0036's own Consequences section named this exact reconciliation as
  future work when that bridge shipped)
