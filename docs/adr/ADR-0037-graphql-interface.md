...
`(namespace, concept, natural_key)` surfaced as a redacted `StorageError` rather than a
caller-actionable validation error (**KI-091 since resolved** too, via
`_require_unique_natural_key()`).
