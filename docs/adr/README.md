...
- [ADR-0020](ADR-0020-hybrid-retrieval-storage-layer.md) — **Hybrid Retrieval: Storage Layer** (`Embedder` port in `core/`, `HashingEmbedder` default, per-scope lazy vector tables, `sqlite-vec` required)
